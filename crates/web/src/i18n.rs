...
mod tests {
    ...
    const EVERY_MSG: [Msg; 33] = [
        Msg::AppName, Msg::Tagline,
        Msg::ModuleBasic, Msg::ModuleAdaptability, Msg::ModuleVelocity, Msg::ModuleFluidness,
        Msg::BlurbBasic, Msg::BlurbAdaptability, Msg::BlurbVelocity, Msg::BlurbFluidness,
        Msg::Accuracy, Msg::Speed, Msg::Fluidness, Msg::Errors, Msg::Time, Msg::AchievedOn,
        Msg::Keyboard, Msg::PracticeLanguage, Msg::InterfaceLanguage, Msg::Lesson,
        Msg::StartTyping, Msg::NewExercise, Msg::Results, Msg::GoalMet, Msg::GoalMissed,
        Msg::Leaderboard, Msg::Nickname, Msg::Publish, Msg::NotPublishable,
        Msg::PublishRules, Msg::Rank, Msg::BoardEmpty, Msg::Offline,
    ];
